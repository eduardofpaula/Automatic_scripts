...
-- Defina as variáveis
DEFINE SYSTEM_password = EduLindo123
DEFINE SYS_password    = EduLindo123
...
-- Executa o mksample
@/opt/oracle/sample-schemas/mksample &SYSTEM_password &SYS_password &HR_password &OE_password &PM_password &IX_password &SH_password &BI_password &default_ts &temp_ts &log_dir &connect_string