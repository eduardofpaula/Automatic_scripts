...
-- Defina as variáveis
DEFINE SYSTEM_password = MinhaSenhaForte123 -- Altere "SuaSenhaAqui" para a mesma senha do SYS passada no container
DEFINE SYS_password    = MinhaSenhaForte123 -- Altere "SuaSenhaAqui" para a mesma senha do SYSTEM passada no container
